...
| 题目 | 类别 | 期望工具 | 实际工具 | 结果 |
| --- | --- | --- | --- | --- |
| AAPL 现在的股价是多少？ | finance_query | ['finance_query'] | [] | ✗ |
| MSFT 现在的市盈率是多少？ | finance_query | ['finance_query'] | [] | ✗ |
| GOOGL 目前的市值是多少？ | finance_query | ['finance_query'] | [] | ✗ |
| 苹果公司最新的每股收益是多少？ | finance_query | ['finance_query'] | [] | ✗ |
| 什么是自由现金流？ | rag_search | ['rag_search'] | [] | ✗ |
| 谷歌最近的 8-K 文件里披露了哪些优先股相关信息？ | rag_search | ['rag_search'] | [] | ✗ |
| 微软最近的 8-K 文件里有什么人事变动？ | rag_search | ['rag_search'] | [] | ✗ |
| 苹果最近和 American Express 有什么合作新闻？ | rag_search | ['rag_search'] | [] | ✗ |
| 今天美股大盘的整体走势如何？ | web_search | ['web_search'] | [] | ✗ |
| 最近有什么关于美联储利率决议的最新消息？ | web_search | ['web_search'] | [] | ✗ |
| 今天全球有什么重要的财经新闻？ | web_search | ['web_search'] | [] | ✗ |
| 你好 | no_tool | [] | [] | ✓ |
| 你是谁？你能做什么？ | no_tool | [] | [] | ✓ |
| 1+1等于几？ | no_tool | [] | [] | ✓ |
| 帮我讲个笑话吧 | no_tool | [] | [] | ✓ |
| 对比一下苹果和微软现在的股价和市盈率 | compound | ['finance_query'] | [] | ✗ |
| 苹果现在股价多少？另外它最近有没有什么值得关注的新闻？ | compound | ['finance_query', 'web_search'] | [] | ✗ |
...
| 指标 | 均值 | p50 | p90 |
| --- | --- | --- | --- |
| 首字延迟 (TTFT) | 0.01s | 0.00s | 0.04s |
| 完整响应延迟 | 115.80s | 150.06s | 150.10s |
